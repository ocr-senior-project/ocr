...
def conv2d(x, W, stride=(1, 1), padding='SAME'):
  return tf.nn.conv2d(input=x, filters=W, strides=[1, stride[0], stride[1], 1], padding=padding)

def max_pool(x, ksize=(2, 2), stride=(2, 2)):
  return tf.nn.max_pool2d(input=x, ksize=[1, ksize[0], ksize[1], 1], strides=[1, stride[0], stride[1], 1], padding='SAME')
